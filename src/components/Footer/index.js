...
function Footer() {
  return (
    <div className="footer d-flex fixed-bottom">
      ...
      <a href="https://www.linkedin.com/in/amanda-perry-713b0955" target="blank" className="d-inline-flex mx-2"><FontAwesomeIcon icon={faLinkedin} size="2x" className="icon" /></a>
